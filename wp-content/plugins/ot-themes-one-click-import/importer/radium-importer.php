...
class Radium_Theme_Importer {
    ...
    public function __construct() {
        if(isset($_POST['ot_demo_file']) && !empty($_POST['ot_demo_file'])) {
          $demo = $_POST['ot_demo_file'].'/';
        } else {
          $demo = 'demo1/';
        }
        self::$instance = $this;
    ...
    public function demo_installer() {
        ...
        <form method="post">
            ...
            <select name="ot_demo_file" style="width: 100px;">              
              <option value="filoxenia">Filoxenia Demo</option> <!-- Davis change -->                    
            </select>
            <br/><br/>
            <span style="display:inline-block; width:150px;">Choose the contents</span>
            <select name="ot_demo_content" style="width: 100px;">
        ...
        if( 'demo-data' == $action && check_admin_referer('radium-demo-code' , 'demononce')) {
          if(isset($_REQUEST['ot_demo_file']) && !empty($_REQUEST['ot_demo_file'])) {
            if(isset($_REQUEST['ot_demo_content'])){
              if("options" == ($_REQUEST['ot_demo_content'])){

                $this->set_demo_theme_options( $this->theme_options_file ); //import before widgets incase we need more sidebars

              }else if("content" == ($_REQUEST['ot_demo_content'])){
              ...
              }else if("widgets" == ($_REQUEST['ot_demo_content'])){
            ...
            echo __("Please Select Which demo file to Import");
          }
        }
    }
