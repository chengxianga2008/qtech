...
?>
        ...
        <link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/bootstrap-lightbox.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/style.css" rel="stylesheet" type="text/css" />
	<link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/dropzone.min.css" type="text/css" rel="stylesheet" />
	<?php
	...
	<link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/jquery.contextMenu.min.css" rel="stylesheet" type="text/css" />	
	<link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>css/bootstrap-modal.min.css" rel="stylesheet" type="text/css" />
	<link href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>jPlayer/skin/blue.monday/jplayer.blue.monday.css" rel="stylesheet" type="text/css">
	<!--[if lt IE 8]><style>
	...
	if (typeof jQuery === 'undefined')
	{
	  document.write(unescape("%3Cscript src='js/jquery.js' type='text/javascript'%3E%3C/script%3E"));
        ...
        <script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/bootstrap-lightbox.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/dropzone.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/jquery.touchSwipe.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/modernizr.custom.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/bootbox.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/bootstrap-modal.min.js"></script>   
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/bootstrap-modalmanager.min.js"></script>
	<script type="text/javascript" src="jPlayer/jquery.jplayer.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/imagesloaded.pkgd.min.js"></script>
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/jquery.queryloader2.min.js"></script>
	<?php
	if($aviary_active){
	...
	<![endif]-->
	<script src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/jquery.ui.position.min.js" type="text/javascript"></script>
	<script src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/jquery-ui-1.10.4.custom.js" type="text/javascript"></script>
	<script src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/jquery.contextMenu.min.js" type="text/javascript"></script>    
	...
	<script type="text/javascript" src="<?php echo WpdmFileManager::getUrl() . '/filemanager/js'; ?>/include.min.js"></script>
...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
	    ...
	    <ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>#tab1" data-toggle="tab"><?php echo lang_Upload_base; ?></a></li>
			<li><a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>#tab2" id="uploader-btn" data-toggle="tab"><?php echo lang_Upload_java; ?></a></li>
	    </ul>
...
<!-- header div end -->
	...
	?>
	<ul class="breadcrumb">	
	<li class="pull-left"><a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?><?php echo $link?>/"><i class="icon-home"></i></a></li>
	...
	?> <li class="active"><?php echo $b?></li><?php
		...
		<li><a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?><?php echo $link.$tmp_path?>"><?php echo $b?></a></li><li><span class="divider"><?php echo "/"; ?></span></li>
	<?php }
	}
	?>
	<li class="pull-right"><a class="btn-small" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" id="info"><i class="icon-question-sign"></i></a></li>
	<li class="pull-right"><a id="refresh" class="btn-small" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>dialog.php?<?php echo $get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a></li>
	
	<li class="pull-right">
	    <div class="btn-group">
		<a class="btn dropdown-toggle sorting-btn" data-toggle="dropdown" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>#">
		  <i class="icon-signal"></i> 
		  <span class="caret"></span>
		</a>
		<ul class="dropdown-menu pull-left sorting">
		    <li><center><strong><?php echo lang_Sorting ?></strong></center></li>
		<li><a class="sorter sort-name <?php if($sort_by=="name"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="name"><?php echo lang_Filename; ?></a></li>
		<li><a class="sorter sort-date <?php if($sort_by=="date"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="date"><?php echo lang_Date; ?></a></li>
		<li><a class="sorter sort-size <?php if($sort_by=="size"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="size"><?php echo lang_Size; ?></a></li>
		<li><a class="sorter sort-extension <?php if($sort_by=="extension"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="extension"><?php echo lang_Type; ?></a></li>
		</ul>
	      </div>
	</li>
	</ul>
	...
	<div class="span12">	    
		...
		<div class="file-name"><a class="sorter sort-name <?php if($sort_by=="name"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="name"><?php echo lang_Filename; ?></a></div>
		<div class="file-date"><a class="sorter sort-date <?php if($sort_by=="date"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="date"><?php echo lang_Date; ?></a></div>
		<div class="file-size"><a class="sorter sort-size <?php if($sort_by=="size"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="size"><?php echo lang_Size; ?></a></div>
		<div class='img-dimension'><?php echo lang_Dimension; ?></div>
		<div class='file-extension'><a class="sorter sort-extension <?php if($sort_by=="extension"){ echo ($descending)?"descending":"ascending"; } ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" data-sort="extension"><?php echo lang_Type; ?></a></div>
		...
		foreach ($files as $file_array) {
			...
			?>
			    ...
			    ?>	<figure data-name="<?php echo $file ?>" class="<?php if($file=="..") echo "back-"; ?>directory" data-type="<?php if($file!=".."){ echo "dir"; } ?>">
				    <a class="folder-link" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>dialog.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>">
			...
			<?php }else{ ?>
				    ...
				    <div class="box">
					<h4 class="<?php if($ellipsis_title_after_first_row){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>dialog.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>"><?php echo $file; ?></a></h4>
				    </div>
				    ...
				    <figcaption>
					    <a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="tip-left edit-button rename-file-paths <?php if($rename_folders && !$file_prevent_rename) echo "rename-folder"; ?>" title="<?php echo lang_Rename?>" data-path="<?php echo $rfm_subfolder.$subdir.$file; ?>" data-thumb="<?php echo $thumbs_path.$subdir.$file; ?>">
					    <i class="icon-pencil <?php if(!$rename_folders || $file_prevent_rename) echo 'icon-white'; ?>"></i></a>
					    <a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="tip-left erase-button <?php if($delete_folders && !$file_prevent_delete) echo "delete-folder"; ?>" title="<?php echo lang_Erase?>" data-confirm="<?php echo lang_Confirm_Folder_del; ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file; ?>"  data-thumb="<?php echo $thumbs_path.$subdir .$file; ?>">
...
?>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				<a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="link" data-file="<?php echo $file; ?>" data-field_id="<?php echo $field_id; ?>" data-function="<?php echo $apply; ?>">
				<div class="img-precontainer">
				...
				<div class="box">				
				<h4 class="<?php if($ellipsis_title_after_first_row){ echo "ellipsis"; } ?>"><a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="link" data-file="<?php echo $file; ?>" data-field_id="<?php echo $field_id; ?>" data-function="<?php echo $apply; ?>">
				...
				<figcaption>
				    ...
				    <a title="<?php echo lang_Download?>" class="tip-right" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" onclick="$('#form<?php echo $nu; ?>').submit();"><i class="icon-download"></i></a>
				    <?php if($is_img && $src_thumb!=""){ ?>
				    <a class="tip-right preview" title="<?php echo lang_Preview?>" data-url="<?php echo $src;?>" data-toggle="lightbox" href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>#previewLightbox"><i class=" icon-eye-open"></i></a>
					...
					href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('');" ><i class=" icon-eye-open"></i></a>
				    <?php }else{ ?>
				    <a class="preview disabled"><i class="icon-eye-open icon-white"></i></a>
				    <?php } ?>
				    <a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="tip-left edit-button rename-file-paths <?php if($rename_files && !$file_prevent_rename) echo "rename-file"; ?>" title="<?php echo lang_Rename?>" data-path="<?php echo $rfm_subfolder.$subdir .$file; ?>" data-thumb="<?php echo $thumbs_path.$subdir .$file; ?>">
 				    <i class="icon-pencil <?php if(!$rename_files || $file_prevent_rename) echo 'icon-white'; ?>"></i></a>

				    <a href="<?php echo WpdmFileManager::getUrl() . '/filemanager/'; ?>javascript:void('')" class="tip-left erase-button <?php if($delete_files && !$file_prevent_delete) echo "delete-file"; ?>" title="<?php echo lang_Erase?>" data-confirm="<?php echo lang_Confirm_del; ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file; ?>" data-thumb="<?php echo $thumbs_path.$subdir .$file; ?>">
