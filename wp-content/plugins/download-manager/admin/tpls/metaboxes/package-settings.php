    ...
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="table table-bordered table-hover">
       ...
       <tr id="package_size_row">
        ...
        <tr id="template_row">
            ...
            <td><?php
                ...
                <select name="file[template]" id="lnk_tpl" onchange="jQuery('#lerr').remove();">
                    <option value="link-template-calltoaction3.php"><?php _e('Select','wpdmpro'); ?></option>
                    <?php
                    $ltpldir = get_stylesheet_directory().'/donwload-manager/link-templates/';
                    if(!file_exists($ltpldir))
                        $ltpldir = WPDM_BASE_DIR.'/tpls/link-templates/';
        ...
        <tr id="page_template_row">
            ...
            <td><?php
                    $ltpldir = get_stylesheet_directory().'/donwload-manager/page-templates/';
                    if(!file_exists($ltpldir))
                        $ltpldir = WPDM_BASE_DIR.'/tpls/page-templates/';
                    $ptpls = scandir($ltpldir);
                    array_shift($ptpls);
                    array_shift($ptpls);
                ?>
                <select name="file[page_template]" id="pge_tpl" onchange="jQuery('#perr').remove();" style="width: 300px">
                    <option value="page-template-1col-flat.php"><?php _e('Select','wpdmpro'); ?></option>
                    <?php
