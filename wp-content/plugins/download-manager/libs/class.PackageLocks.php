...
DATA;
  ...
  <div class="panel-body">
        ...
        <input type="email" required="required" class="form-control group-item email-lock-mail" placeholder="Enter Email" size="20" id="email_' . $unqid . '_' . $package['ID'] . '" name="email" style="margin:5px 0" />
        ...
        jQuery(".wpdmdlf_' . $unqid . '_' . $package['ID'] . '").submit(function(){
            ...
            jQuery(".emsg_' . $unqid . $package['ID'] . '").removeAttr("style").html("'.__('Processing...','wpdmpro').'").show();
