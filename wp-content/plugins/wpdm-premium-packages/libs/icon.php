...
foreach($fileinfo as $index=>$value):
    ...
    if(in_array($ext,$img)): ?>
        ...
        <input rel="wdmiconfile" style="display:none" <?php if(isset($icon) && $icon==$value['file']) echo ' checked="checked" ' ?> type="radio"  name="wpdmpp_list[icon]"  class="checkbox"  value="<?php echo $value['file'] ?>">
