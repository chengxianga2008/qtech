...
class WPDMPPCustomColumns {
    ...
    function ColumnsTH($defaults) {
        ...
        $otf['wpdmuprice'] = "Price";
        $otf['wpdmsaleqty'] = "<span title='Sales Quantity' class='ttip'>Qyantity</span>"; //<span class='fa-stack' style='font-size: 0.8em'><i class='fa fa-circle-thin fa-stack-2x'></i><i  style='font-size: 80%' class='fa fa-shopping-cart fa-stack-1x'></i></span>";
        $otf['wpdmsaleamt'] = "<span title='Total Sales' class='wpdm-th-icon ttip' style=''><i class='fa fa-money'></i></span>";
