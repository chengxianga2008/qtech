...
add_action('show_user_profile', 'wpdmpp_add_custom_user_profile_fields');
add_action('edit_user_profile', 'wpdmpp_add_custom_user_profile_fields');

add_action('personal_options_update', 'wpdmpp_save_custom_user_profile_fields');
add_action('edit_user_profile_update', 'wpdmpp_save_custom_user_profile_fields');

function wpdmpp_add_custom_user_profile_fields($user){
...
function wpdmpp_save_custom_user_profile_fields($user_id){
