<div class="wrap">
<h2><?php _e('Product Report','wpmarketplace');?></h2>
...
$discount_r = 0; //role based discount is not included here.
$cTotal = 0;
$cCount = 0;
...
foreach ($result as $oitem) {
    ...
    $total = number_format(((($oitem->price + $prices) * $oitem->quantity) - $discount - $oitem->coupon_amount), 2,".","");
    $cCount += $count;
    $cTotal += $total;
