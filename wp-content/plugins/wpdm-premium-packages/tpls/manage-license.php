...
Order ID: <input type="text" name="oid" value="<?php echo isset($_REQUEST['oid'])?$_REQUEST['oid']:''; ?>">

License No: <input type="text" name="licenseno" value="<?php echo isset($_REQUEST['licenseno'])?$_REQUEST['licenseno']:''; ?>">

<input type="submit" class="button-secondary action" id="doaction" name="doaction" value="Apply">

| <b><?php echo $t; ?> license(s) found</b>
</div>
...
<table cellspacing="0" class="widefat fixed">
    ...
    <th style="" class="manage-column column-media" id="media" scope="col">License No</th>     
    <th style="" class="manage-column column-author" id="author" scope="col">Product Name</th>
    <th style="" class="manage-column column-author" id="author" scope="col">Order ID</th>
    <th style="" class="manage-column column-parent" id="parent" scope="col">Activation Date</th>
    <th style="" class="manage-column column-parent" id="parent" scope="col">Expire Date</th>
    <th style="" class="manage-column column-parent" id="parent" scope="col">Status</th>
    </tr>
    </thead>
    ...
    <tr valign="top" class="<?php if($i%2==0) echo 'alternate'; ?> author-self status-inherit" id="post-8">
                ...
                <td class="media column-media">
                    <strong><a title="Edit" href="edit.php?post_type=wpdmpro&page=pp-license&task=editlicense&id=<?php echo $license->id; ?>"><?php echo $license->licenseno; ?></a></strong>
                </td>
                <td class="author column-author"><?php echo $license->productname; ?></td>
                <td class="author column-author"><a target="_blank" href="edit.php?post_type=wpdmpro&page=orders&task=vieworder&id=<?php echo $license->oid; ?>"><?php echo $license->oid; ?></a></td>
