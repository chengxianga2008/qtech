    ...
    <div class="panel-body">
        ...
        <div class="row row-fluid">
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_first_name"><?php echo __("First Name", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_last_name"><?php echo __("Last Name", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
        ...
        <div class="row row-fluid">
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_address_1"><?php echo __("Address Line 1", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
        ...
        <div class="row row-fluid">
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_city"><?php echo __("Town/City", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
        ...
        <div class="row row-fluid">
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_postcode"><?php echo __("Postcode/Zip", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_country"><?php echo __("Country", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
                <?php
                global $wpdb;
        ...
        <div class="row row-fluid">
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_state"><?php echo __("State/County", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_email"><?php echo __("Email Address", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
        ...
        <div class="row row-fluid">
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_phone"><?php echo __("Phone", "wpmarketplace"); ?> <i class="fa fa-star text-danger ttip" title="Required"></i></label>
            ...
            <div class="form-group col-md-6 span6">
                <label class="" for="billing_tin"><?php echo __("Tax ID #", "wpmarketplace"); ?></label>
