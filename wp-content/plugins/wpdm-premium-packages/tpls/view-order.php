...
<div class="wrap">
    ...
    <div class="w3eden">
        ...
        <div id="msg" style="border-radius: 3px;display: none;" class="alert alert-success"><?php echo __("Message", "wpmarketplace"); ?></div>
        <div class="row">
            <div class=" col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo __("Order ID:", "wpmarketplace"); ?></div>
            ...
            <div class=" col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo __("Order Date:", "wpmarketplace"); ?></div>
                    <div class="panel-body">
            ...
            <div class=" col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo __("Order Total:", "wpmarketplace"); ?></div>
                    <div class="panel-body">
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading"><?php echo __("Order Summary", "wpmarketplace"); ?></div>
        <table class="table">
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading"><?php echo __("Customer Info", "wpmarketplace"); ?></div>
    <?php if($order->uid>0){ ?>
        <table class="table">

            <tbody>

            <tr><td><?php echo __("Customer Name:", "wpmarketplace"); ?></td><td><a href='user-edit.php?user_id=<?php echo $user->ID; ?>'><?php echo $user->display_name; ?></a></td></tr>
            <tr><td><?php echo __("Customer Email:", "wpmarketplace"); ?></td><td><a href='mailto:<?php echo $user->user_email; ?>'><?php echo $user->user_email; ?></a></td></tr>
            </tbody>
        </table>
    ...
    <table class="table">
        <thead>
        <tr><th align="left"><?php echo __("This order is not associated with any user", "wpmarketplace"); ?></th></tr>
        </thead>
        <tr><td align="left" id="ausre" ><div class="input-group"><input placeholder="Username" type="text" class="form-control input-sm" id="ausr"><span class="input-group-btn"><input type="button" id="ausra" class="btn btn-primary btn-sm" value="<?php echo __("Assign User", "wpmarketplace"); ?>"></span></div></td></tr>
     </table>
    <?php } ?>
            </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo __("IP Information", "wpmarketplace"); ?></div>
                    <table class="table">

                        <tr><td><?php echo __("IP Address:", "wpmarketplace"); ?></td><td><?php echo $order->IP; ?></td></tr>
                        <tr><td><?php echo __("Location:", "wpmarketplace"); ?></td><td><div id="iploc">
                                    <script>
                                        jQuery(function(){
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><?php echo __("Order Items:", "wpmarketplace"); ?></div>
...
<script language="JavaScript">
    ...
    jQuery(function(){
        ...
        <?php
            ...
            $style = array('Pending'=>'btn-warning','Expired'=>'btn-danger','Processing' => 'btn-info','Completed'=>'btn-success','Bonus' => 'btn-success','Gifted' => 'btn-success', 'Cancelled' => 'btn-danger','Disputed' => 'btn-danger','Refunded' => 'btn-danger');
