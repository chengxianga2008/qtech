...
<h1 class="text-left">Login</h1>
    <?php
    global $wp_query; if($_SESSION['login_error']!='') {  ?>
    ...
    <?php } ?>
            <p class="login-username text-left">
                ...
                <input type="text" name="wpdm_login[log]" id="user_login" class="input" value="" size="20" tabindex="10" />
            </p> 
            <p class="login-password text-left">
                <label  for="user_pass"><?php echo __("Password","wpmarketplace"); ?></label> 
                <input type="password" name="wpdm_login[pwd]" id="user_pass" class="input" value="" size="20" tabindex="20" />
            </p> 
