    ...
    <div style="<?php if ($current_user->ID) echo "display:none"; else echo "";?>" id="csl">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel-heading"><b><?php echo __("Register", "wpmarketplace"); ?></b></div>
                <div class="panel-body">
                    <p><?php echo __('If you don\'t have an account signup here:', "wpmarketplace"); ?></p>
                <div style="display: none;" id="rloading_first"><img  src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" /></div><div id="rloading_message"></div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" id="registerform_user_login" value="<?php echo isset($_SESSION['tmp_reg_info']['user_login'])?$_SESSION['tmp_reg_info']['user_login']:''; ?>" name="wpdm_reg[user_login]" required/>
                    </div>
                    <div class="form-group">
                        <label ><?php echo __("E-mail", "wpmarketplace"); ?></label>
                        <input type="text" class="email form-control" id="registerform_user_email" value="<?php echo isset($_SESSION['tmp_reg_info']['user_email'])?$_SESSION['tmp_reg_info']['user_email']:''; ?>" name="wpdm_reg[user_email]" required/>
                    </div>
                    <div class="form-group">
                        <label ><?php echo __("Password", "wpmarketplace"); ?></label>
                        <input type="password" class="form-control" id="registerform_user_pass" value="<?php echo isset($_SESSION['tmp_reg_info']['user_email'])?$_SESSION['tmp_reg_info']['user_email']:''; ?>" name="wpdm_reg[user_pass]" required/>
                    </div>
                    <div class="form-group">
                ...
                <form id="loginform" action="<?php the_permalink(); echo $sap; ?>&task=login" method="post" style="margin-top: 0 !important;"><div class="panel panel-default">
                <div class="panel-heading"><b><?php echo __("Login", "wpmarketplace"); ?></b></div>
                <div class="panel-body"> 
                ...
                <div style="display: none;" id="loading_first"><img  src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" /></div><div id="loading_message"></div>
                    ...
                    <div class="form-group">
                       <label  for="loginform_user_login"><?php echo __("Username", "wpmarketplace"); ?></label> 
                       <input type="text" name="wpdm_login[log]" id="loginform_user_login" class="form-control" value="" required/>
                    </div>
                    <div class="form-group">
                            <label  for="loginform_user_pass"><?php echo __("Password", "wpmarketplace"); ?></label> 
                            <input type="password" name="wpdm_login[pwd]" id="loginform_user_pass" class="form-control" value="" required/>
                    </div>
                    <div class="checkbox">
                    <label>
                        <input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php echo __("Remember Me", "wpmarketplace"); ?>
                    </label>
                    </div> 
                ...
                <div class="panel-footer">
                     ...
                     <a class="pull-right" href="<?php echo home_url('wp-login.php?action=lostpassword'); ?>"><?php echo __('Forgot password?', "wpmarketplace"); ?></a>
