...
$loginurl = home_url("/wp-login.php?redirect_to=".urlencode($orderurl));
    ...
    $odetails   = __("All Orders","wpmarketplace");
...
ITEM;
            ...
            $vdlink_expired = sprintf(__("Get continuous support and update for another %d days", "wpmarketplace"), $wpdmpp_settings['order_validity_period']);
