...
?>
<link rel="stylesheet" type="text/css" href="<?php echo WPDMPP_BASE_URL ?>css/icons/flaticon.css" />
<style>
...
<div class="wrap admin-orders">
 <h2><?php echo __("Orders","wpmarketplace");?></h2>
...
<?php echo __("Date","wpmarketplace");?><span class="ttip" title="(yyyy-mm-dd)">(?)</span> :
<?php echo __("from","wpmarketplace");?> <input size="10" type="text" name="sdate" value="<?php if(isset($_REQUEST['sdate'])) echo $_REQUEST['sdate']; ?>">
<?php echo __("to","wpmarketplace");?> <input size="10" type="text" name="edate" value="<?php if(isset($_REQUEST['edate'])) echo $_REQUEST['edate']; ?>">

<?php echo __("Order ID:","wpmarketplace");?> <input size="10" type="text" name="oid" value="<?php if(isset($_REQUEST['oid'])) echo $_REQUEST['oid']; ?>">

<input type="submit" class="button-secondary action" id="doaction" name="doaction" value="Apply">

| <b><?php echo $t; ?> <?php echo __("order(s) found","wpmarketplace");?></b>
| <span style="color: #3498DB;font-weight: 900"><?php echo __("Total Sales:","wpmarketplace");?> <?php $total = $wpdb->get_var("select sum(total) as tamount from {$wpdb->prefix}ahm_orders where payment_status='Completed' or payment_status='Expired'"); echo '$'.number_format($total,2); ?></span>
...
<table cellspacing="0" class="widefat fixed">
    ...
    <th style="width: 40px" class="manage-column" id="media" scope="col">
        <div class="w3eden">
                    <span class="fa-stack ttip" title="<?php echo __("Order Status","wpmarketplace");?>">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
                      <i class="fa fa-bars fa-stack-1x"></i>
                    </span>
    </div>
    </th>
    <th style="" class="manage-column" id="media" scope="col"><?php echo __("Order","wpmarketplace");?></th>

        <th style="width: 40px" class="manage-column" id="media" scope="col">
            <div class="w3eden">
            <span class="fa-stack ttip" title="<?php echo __("Payment Status","wpmarketplace");?>">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
                      <i class="fa fa-money fa-stack-1x"></i>
                    </span></div></th>
        <th style="width: 150px" class="manage-column" id="author" scope="col"><?php echo __("Total","wpmarketplace");?></th>
    <th style="" class="manage-column" id="author" scope="col"><?php echo __("Customer","wpmarketplace");?></th>

    <th style="width: 200px" class="manage-column column-parent" id="parent" scope="col"><?php echo __("Order Date","wpmarketplace");?></th>
        <th style="width: 40px" class="manage-column" id="parent" scope="col">
            <div class="w3eden">
                    <span class="fa-stack ttip" title="<?php echo __('Item Download Status','wpmarketplace'); ?>">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
    ...
    <tr>
        ...
        <th style="" class="manage-column" id="media" scope="col" title="<?php echo __("Order Status","wpmarketplace");?>"><span class="fa-stack">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
                      <i class="fa fa-bars fa-stack-1x"></i>
                    </span></th>
        <th style="" class="manage-column" id="media" scope="col"><?php echo __("Order","wpmarketplace");?></th>

        <th style="width: 40px" class="manage-column" id="media" scope="col" title="<?php echo __("Payment Status","wpmarketplace");?>"><span class="fa-stack">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
                      <i class="fa fa-money fa-stack-1x"></i>
                    </span></th>
        <th style="" class="manage-column" id="author" scope="col"><?php echo __("Total","wpmarketplace");?></th>
        <th style="" class="manage-column " id="author" scope="col"><?php echo __("Customer","wpmarketplace");?></th>

        <th style="" class="manage-column" id="parent" scope="col"><?php echo __("Order Date","wpmarketplace");?></th>
        <th style="width: 40px" class="manage-column" id="parent" scope="col">
            <div class="w3eden">
                    <span class="fa-stack ttip" title="<?php echo __('Item Download Status','wpmarketplace'); ?>">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
    ...
    <tr valign="top" class="<?php echo $z;?> author-self status-inherit" id="post-8">
                ...
                <td class="">
                    <strong>
                    <a title="Edit" href="edit.php?post_type=wpdmpro&page=orders&task=vieworder&id=<?php echo $order->order_id; ?>">
                    <?php echo $order->title; ?> #<?php echo $order->order_id; ?>
                    </a>
                    </strong><br/>
                    <small><?php echo $items; ?> <?php echo __("items","wpmarketplace");?></small>

                </td>
        <td class=""><div class="w3eden"><span title="<?php echo $order->payment_status; ?>" class="fa-stack oa-<?php echo $order->payment_status; ?>">
                      <i class="fa fa-circle-thin fa-stack-2x"></i>
                ...
                <td class=""><?php echo $currency?$currency:'$'; echo number_format($order->total,2); ?><br/>
                    <small class="note"><?php _e('Via','wpmarketplace'); echo " ".$order->payment_method; ?></small>
                </td>

                <td class=""><?php if(is_object($user_info)){ ?>
                        <b><a href="user-edit.php?user_id=<?php echo $user_info->ID; ?>"><?php echo $user_info->display_name; ?></a></b>&nbsp;<a class="text-filter" href="edit.php?post_type=wpdmpro&page=orders&customer=<?php echo $user_info->ID; ?>"><i class="fa fa-search"></i></a><br/><a href="mailto:<?php echo $user_info->user_email; ?>"><?php echo $user_info->user_email; ?></a><?php } ?></td>

                <td class=""><?php echo date("M d, Y h:i a",$order->date); ?></td>
                <td style="" class="" id="parent" scope="col">
                    <div class="w3eden">
                            <span class="fa-stack download-<?php echo $order->download==0?'off':'on'; ?> ttip" title="<?php echo $order->download==0?__('New','wpmarketplace'):__('Downloaded','wpmarketplace'); ?>">
                              <i class="fa fa-circle-thin fa-stack-2x"></i>
