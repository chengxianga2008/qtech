        ...
        <div>
           ...
           if($settings['calc_shipping']==1){
              ...
              if($settings['free_shipping_enabled']==1){
                  if(wpdmpp_get_cart_subtotal() >= $settings['free_shipping_min_amount']){
              ...
              if($settings['local-delivery_enabled']==1){
                  if($settings['local-delivery_type']!="free"){
                      if($settings['local-delivery_type']=="fixed")
                        ...
                        $delivery_fee=(wpdmpp_get_cart_subtotal()*($settings['local-delivery_fee']/100));
           ...
           $ship_methods=apply_filters("wpdmpp_apply_shipping_method",$ship_methods);
           echo $ship_methods;
?>           </select>   <br>
