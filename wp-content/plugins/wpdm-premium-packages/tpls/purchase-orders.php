<div class='panel panel-default dashboard-panel' style='margin: 10px 0'><div class='panel-heading'>If you do not see your order:</div><div class='panel-body'>
...
if(!isset($_GET['id']) && !isset($_GET['item'])){
    ...
    $payment_status=__("Status","wpmarketplace");
$_ohtml = <<<ROW
