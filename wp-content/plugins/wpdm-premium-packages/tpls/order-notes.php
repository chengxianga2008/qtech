...
foreach ($order_notes['messages'] as $time => $order_note) {
    ...
    <?php } ?>
        <div class="panel-footer text-right"><small><em><i class="fa fa-pencil"></i> <?php echo $order_note['by']; ?> &nbsp; <i class="fa fa-clock-o"></i> <?php echo date(get_option('date_format') . " h:i", $time); ?></em></small>
