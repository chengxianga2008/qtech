...
?>
    ...
    <div class="pin">
        ...
        <div class="pull-left">
        <?php if(function_exists('wpdmpp_product_price')) echo wpdmpp_currency_sign().wpdmpp_product_price(get_the_ID()); ?>
        </div>
        <div class="pull-right">
            <?php if(function_exists('wpdmpp_addtocart_link')) echo wpdmpp_addtocart_link(get_the_ID()); ?>
        </div>
