<div class="ihc-subtab-menu">
	<a class="ihc-subtab-menu-item" href="<?php echo $url.'&tab='.$tab.'&subtab=add_edit';?>"><?php _e('Add Single Coupon', 'ihc');?></a>
	<a class="ihc-subtab-menu-item" href="<?php echo $url.'&tab='.$tab.'&subtab=multiple_coupons';?>"><?php _e('Add Bulk Coupons', 'ihc');?></a>	
