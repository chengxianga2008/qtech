	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="inside" style="padding-bottom:30px;">
				...
				<div class="iump-wp_editor" style="float:left; width: 69%;">
				...
				<div style="width: 20%; display: inline-block; vertical-align: top;margin-left: 10px; color: #333;">
					<?php 
						$constants = array( '{username}'=>'', '{user_email}'=>'', '{first_name}'=>'', 
											'{last_name}'=>'', '{account_page}'=>'', '{login_page}'=>'', 
											'{level_list}'=>'',	'{blogname}'=>'', '{blogurl}'=>'',
						);
			...
			<div class="" style="padding: 10px 5px;border-bottom: 1px solid #fafafa;">
				...
				<p><?php _e('General content for Users who does not have assigned a Page to show up on "Overview" section:', 'ihc');?></p>
				<div  class="iump-wp_editor" style="float:left; width:79%;">
