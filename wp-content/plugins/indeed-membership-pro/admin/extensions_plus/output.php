			...
			<div data-keywords="<?php echo $keywords;?>" data-category="<?php echo $item['category'];?>" class="indeed-item-wrapp">
			  <div class="indeed-item">
				...
				<div class="indeed-item-inner">
					...
					<?php echo substr($item['long_description'],0,133);?>...<a href="" class="indeed-addon-more">Learn more</a>
					<?php }?>
					</div>
					<?php if (!empty($item['envato_link'])){?>
					...
					<div class="indeed-addon-demo-link">
						<?php if ($installed){?>
						<div style=" color:#fff; background: #d54e21; padding: 4px 16px 4px 13px; margin: 0 0 0 -13px;">Installed</div>
						<?php } else { ?>
