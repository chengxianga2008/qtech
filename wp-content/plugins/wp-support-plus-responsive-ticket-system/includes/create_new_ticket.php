...
<div id="loginContainer">
	...
	{?>
	<h3><?php echo __('OR', 'wp-support-plus-responsive');?></h3>
	<?php
	}
	?>
	...
	<div id="facebook_login_btn">
		<fb:login-button scope="public_profile,email" onlogin="checkLoginState();"><?php echo __('Login with Facebook', 'wp-support-plus-responsive');?></fb:login-button>
	</div>
