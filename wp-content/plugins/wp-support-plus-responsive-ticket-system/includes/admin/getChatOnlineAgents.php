	...
	?>
		...
		<div class="onlineAgent">
			...
			<div class="supportAgentInfo">
				<div class="supportAgentName"><?php _e($administrator->display_name,'wp-support-plus-responsive');?></div>
				<small><b><?php _e('Skype ID:','wp-support-plus-responsive');?></b> <?php _e($currentAgentSettings->skype_id,'wp-support-plus-responsive');?></small>
			</div>
		</div>
		</a>
	<?php }
...
foreach ($supervisors as $supervisor){
	...
	if($currentAgentSettings->skype_chat_availability){
		...
		<div class="onlineAgent">
			...
			<div class="supportAgentInfo">
				<div class="supportAgentName"><?php _e($supervisor->display_name,'wp-support-plus-responsive');?></div>
				<small><b><?php _e('Skype ID:','wp-support-plus-responsive');?></b> <?php echo $currentAgentSettings->skype_id;?></small>
			</div>
		</div>
		</a>
	<?php }
...
foreach ($agents as $agent){
	...
	if($currentAgentSettings->skype_chat_availability){
		...
		<div class="onlineAgent">
			...
			<div class="supportAgentInfo">
				<div class="supportAgentName"><?php _e($agent->display_name,'wp-support-plus-responsive');?></div>
				<small><b><?php _e('Skype ID:','wp-support-plus-responsive');?></b> <?php _e($currentAgentSettings->skype_id,'wp-support-plus-responsive');?></small>
			</div>
		</div>
		</a>
...
if(!$agentAvailable){
	echo "<h2>".__('Sorry, currently no agent available for chat!!!','wp-support-plus-responsive')."</h2>";
}
?>
