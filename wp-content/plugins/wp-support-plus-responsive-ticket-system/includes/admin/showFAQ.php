...
<a href="<?php echo admin_url('admin.php?page=wp-support-plus-faq&type=add');?>" class="btn btn-primary"><?php _e("+ Add New",'wp-support-plus-responsive');?></a>
<br><br>
<?php 
global $wpdb;
...
<table class="table table-striped table-hover">
	  <tr>
		  ...
		  <th><?php _e('Question','wp-support-plus-responsive');?></th>
...
<?php 
if(!$faqs){?>
	<div style="text-align: center;"><?php _e("No FAQ's Found",'wp-support-plus-responsive');?></div>
	<hr>
<?php }?>
