...
<ul class="nav nav-tabs">
	<li class="active"><a href="#settingsAdvanced" id="tab_advanced_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][3],'wp-support-plus-responsive');?></a></li>
	<li><a href="#settingsCustomStatus" id="tab_custom_status_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][9],'wp-support-plus-responsive');_e($ticket_label,'wp-support-plus-responsive');?></a></li>
	<li><a href="#settingsCustomPriority" id="tab_custom_priority_container" data-toggle="tab"><?php _e('Change Status','wp-support-plus-responsive');?></a></li>
	<li><a href="#settingsFieldsReorder" id="tab_fields_reorder_container" data-toggle="tab"><?php _e('Assign Agent','wp-support-plus-responsive');?></a></li>
	<li><a href="#settingsTicketListFields" id="tab_ticket_list_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][10],'wp-support-plus-responsive');?></a></li>
</ul>
<!-- Tab panes -->
