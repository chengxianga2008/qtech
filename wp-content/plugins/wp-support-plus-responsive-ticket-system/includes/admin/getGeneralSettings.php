...
<span class="label label-info wpsp_title_label"><?php _e('Default Category','wp-support-plus-responsive');?></span><br/><br/>
<table>
  <tr>
...
<small><code>*</code><?php _e('Selected Category will be default category for new tickets.','wp-support-plus-responsive');?></small><br>
<hr/>
<!----------------------------Code End------------------------------------------------------>

<!---------------------------Code to add default status--------------------------------->
<span class="label label-info wpsp_title_label"><?php _e('Default Status','wp-support-plus-responsive');?></span><br/><br/>
<table>
  <tr>
    <td class="tblGeneralStingsTdFirst">
...
<small><code>*</code><?php _e('Selected Status will be assigned to new tickets.','wp-support-plus-responsive');?></small><br>
<hr/>
<!----------------------------Code End------------------------------------------------------>

<!---------------------------Code to add default ticket status after cust reply--------------------------------->
<span class="label label-info wpsp_title_label"><?php _e('Ticket Status After Customer Reply','wp-support-plus-responsive');?></span><br/><br/>
<table>
  <tr>
    <td class="tblGeneralStingsTdFirst">
...
<small><code>*</code><?php _e('Ticket status will be changed to selected status (other than default) after ticket creator reply back.','wp-support-plus-responsive');?></small><br>
<hr/>
<!----------------------------Code End------------------------------------------------------>
<!---------------------------Code for ticket type settings--------------------------------->

<span class="label label-info wpsp_title_label"><?php _e('Close Ticket','wp-support-plus-responsive');?></span><br><br>
<?php _e('Label','wp-support-plus-responsive');?>: <input type="text" id="wpsp_close_btn_alice" value="<?php echo $generalSettings['close_btn_alice'];?>"><br><br>
<?php _e('Select Status','wp-support-plus-responsive');?>:
<select id="close_btn_ticket_status" name="reply_ticket_status">
        ...
        <?php
        foreach($custom_statusses as $custom_status){?>
            <option value="<?php echo strtolower($custom_status->name);?>" <?php echo ($generalSettings['close_ticket_btn_status_val']==strtolower($custom_status->name))?'selected="selected"':'';?>><?php _e(ucfirst($custom_status->name),'wp-support-plus-responsive');?></option>
        <?php
    }
        ?>
</select>
...
<span class="label label-info wpsp_title_label"><?php _e('Ticket Type Settings','wp-support-plus-responsive');?></span><br><br>
<small><code>*</code><?php _e('If enabled, users will be able to make a ticket public/private from front end.','wp-support-plus-responsive');?></small><br>
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Allow users to make a ticket public/private from front end.','wp-support-plus-responsive');?></td>
  </tr>
</table><br>
<small><code>*</code><?php _e('If users are allowed to make a ticket public/private this will be the selected type for ticket. If user is not allowed to select ticket type from front end then this will be the type of the ticket created from front end.','wp-support-plus-responsive');?></small><br>
<?php _e('Default Ticket Type','wp-support-plus-responsive');?>:
<select id="setDefaultTicketType">
	<option value="0" <?php echo ($generalSettings['default_ticket_type']=='0')?'selected="selected"':'';?>><?php _e('Private','wp-support-plus-responsive');?></option>
	<option value="1" <?php echo ($generalSettings['default_ticket_type']=='1')?'selected="selected"':'';?>><?php _e('Public','wp-support-plus-responsive');?></option>
</select><br>
<hr>
<!----------------------------Code End------------------------------------------------------>
...
<?php _e('Button Position','wp-support-plus-responsive');?>:<br>
 ...
 */
?>
<span class="label label-info wpsp_title_label"><?php _e('Front End Ticket Submission','wp-support-plus-responsive');?></span><br><br>
<small><code>*</code><?php _e('If enabled, prevents the submission of new tickets from the front end by logged in users. This may be useful if you want tickets to only be raised via email piping','wp-support-plus-responsive');?></small><br>
...
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Prevent Front End Ticket Submission','wp-support-plus-responsive');?></td>
  </tr>
</table>
<hr />
<?php
...
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Register Guest as User','wp-support-plus-responsive');?></td>
  </tr>
</table>
<table>
  <tr>
    <td class="tblGeneralStingsTdFirst"><?php _e('Role for new user','wp-support-plus-responsive');?>:</td>
...
<hr>
<small><code>*</code><?php _e('If enabled, Guest user will be able to add attachment to a ticket. Note. This setting is applicable for front end tickets only','wp-support-plus-responsive');?></small><br>
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Allow attachments for guest tickets','wp-support-plus-responsive');?></td>
  </tr>
</table><br>
<!-- Code end -->
<small><code>*</code><?php _e('If not set bellow API key and secret, Google No CAPTCHA reCAPTCHA will not be loaded. This is applicable to guest ticket form only!','wp-support-plus-responsive');?><br><a href="https://www.google.com/recaptcha/admin"><?php _e('Click here','wp-support-plus-responsive');?></a> <?php _e('to get API key for your site.','wp-support-plus-responsive');?></small><br>
<table>
  <tr>
    <td class="tblGeneralStingsTdFirst"><?php _e('Google reCAPTCHA Site Key','wp-support-plus-responsive');?>:</td>
  ...
  <tr>
    <td class="tblGeneralStingsTdFirst"><?php _e('Google reCAPTCHA Secret key','wp-support-plus-responsive');?>:</td>
...
<span class="label label-info wpsp_title_label"><?php _e('Default Login','wp-support-plus-responsive');?></span><br><br>
<small><code>*</code><?php _e('If enabled, it will display default login form link and default login form will be enabled','wp-support-plus-responsive');?></small><br>
<table>
    <tr>
      ...
      <td class="tblGeneralStingsTdSecond"><?php _e('Enable Default Login','wp-support-plus-responsive');?></td>
    </tr>
    <tr>
       <td class="tblGeneralStingsTdFirst">
       ...
       <td class="tblGeneralStingsTdSecond">
           <?php _e('Default Login Module','wp-support-plus-responsive');?>
       </td>
    </tr>
    <tr>
       <td class="tblGeneralStingsTdFirst">
       ...
       <td class="tblGeneralStingsTdSecond">
           <?php _e('Wp Login Link','wp-support-plus-responsive');?>
       </td>
    </tr>
</table><br>
<hr>
...
<span class="label label-info wpsp_title_label"><?php _e('Agent Settings','wp-support-plus-responsive');?></span><br><br>
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Allow Agents to assign tickets','wp-support-plus-responsive');?></td>
  </tr>
</table><br>
<table>
  <tr>
    ...
    <td class="tblGeneralStingsTdSecond"><?php _e('Allow Agents to delete tickets','wp-support-plus-responsive');?></td>
  </tr>
</table><br>
...
<small><code>*</code><a data-toggle="modal" data-target="#wpl_facebook_modal"><?php _e('Click Here','wp-support-plus-responsive');?></a> <?php _e('for help to create App','wp-support-plus-responsive');?></small><br>
<table>
  <tr>
