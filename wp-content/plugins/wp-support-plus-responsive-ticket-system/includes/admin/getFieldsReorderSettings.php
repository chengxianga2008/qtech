			...
			{	if(is_numeric($field_id))
				{
					...
					<tr id="<?php echo $field_num;?>">
						...
						<td>
							...
							<input type="radio" name="field_status_<?php echo $field_id;?>" value="1" checked><?php _e('Enable','wp-support-plus-responsive');?>
							<input type="radio" name="field_status_<?php echo $field_id;?>" value="0"><?php _e('Disable','wp-support-plus-responsive');?>
							<?php }else {?>
							<input type="radio" name="field_status_<?php echo $field_id;?>" value="1"><?php _e('Enable','wp-support-plus-responsive');?>
							<input type="radio" name="field_status_<?php echo $field_id;?>" value="0" checked><?php _e('Disable','wp-support-plus-responsive');?>
							<?php }?>
						</td>
						<td></td>
					</tr>
				...
				else
				{
					switch($field_id){
						case 'dn':?>
							<tr id="<?php echo $field_num;?>">
								<td><?php echo $field_num++;?></td>
								<td><?php _e('Name','wp-support-plus-responsive');?></td>
								...
								<td>
									<?php _e('Label','wp-support-plus-responsive');?>:&nbsp;
						...
						case 'de':?>
							<tr id="<?php echo $field_num;?>">
								<td><?php echo $field_num++;?></td>
								<td><?php _e('Email Address','wp-support-plus-responsive');?></td>
								<td style="display:none;"><?php echo $field_id;?></td>
								<td>
									<div style="display: none;">
									<?php if(in_array($field_id,$advancedSettingsFieldOrder['display_fields'])){ ?>
							...
							<tr id="<?php echo $field_num;?>">
								...
								<td>
									<?php _e('Label','wp-support-plus-responsive');?>:&nbsp;
                                                                        ...
                                                                        <?php _e('Default value if disabled','wp-support-plus-responsive');?>:&nbsp;
						...
						case 'dd':?>
							<tr id="<?php echo $field_num;?>">
								<td><?php echo $field_num++;?></td>
								<td><?php _e('Description','wp-support-plus-responsive');?></td>
								<td style="display:none;"><?php echo $field_id;?></td>
								<td>
									<div style="display: none;">
									<?php if(in_array($field_id,$advancedSettingsFieldOrder['display_fields'])){ ?>
...
<input type="button" onclick="setFieldReorderSettings();" class="btn btn-success" value="<?php _e('Save Settings','wp-support-plus-responsive');?>">
