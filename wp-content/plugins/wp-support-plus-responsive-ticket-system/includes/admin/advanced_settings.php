...
<ul class="nav nav-tabs">
    <li class="active"><a href="#settingsAdvanced" id="tab_advanced_container" data-toggle="tab"><?php _e('Advanced Settings','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsCustomStatus" id="tab_custom_status_container" data-toggle="tab"><?php _e('Custom Status','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsCustomPriority" id="tab_custom_priority_container" data-toggle="tab"><?php _e('Custom Priority','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsFieldsReorder" id="tab_fields_reorder_container" data-toggle="tab"><?php _e('Re-Order Fields','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsTicketListFields" id="tab_ticket_list_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][4],'wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsCustomFilterFrontEnd" id="tab_custom_filter_container" data-toggle="tab"><?php _e('Custom Filter FrontEnd','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsCKEditor" id="tab_ckeditor_settings" data-toggle="tab"><?php _e('CKEditor','wp-support-plus-responsive');?></a></li>
    <li><a href="#settingsSupportButton" id="tab_support_btn_container" data-toggle="tab"><?php _e('Change Icons','wp-support-plus-responsive');?></a></li>
    <?php
