...
<form id='frmETChangeTicketStatus'>
	<span class="label label-info wpsp_title_label">
	<?php _e("Change Status Notification Email", 'wp-support-plus-responsive' );?>
	</span><br><br>
	<table class='wpsp_et_role_tbl'>
	  ...
	  <tr>
        ...
        [<?php echo __($advancedSettings['ticket_label_alice'][1],'wp-support-plus-responsive');?> <?php echo $advancedSettings['wpsp_ticket_id_prefix'];?>] <input type="text" id='wpsp_et_change_ticket_status_suject' name='wpsp_et_change_ticket_status_suject' style="width: 50%;" value='<?php echo htmlspecialchars(stripcslashes($wpsp_et_change_ticket_status['mail_subject']), ENT_QUOTES);?>'/><br>
