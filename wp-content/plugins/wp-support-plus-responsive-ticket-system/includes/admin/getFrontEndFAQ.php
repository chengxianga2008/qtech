...
<div class="table-responsive">
	<table id="tblFontEndTickets" class="table table-striped table-hover">
	  <tr>
		  <th><?php echo __("FAQ's", 'wp-support-plus-responsive');?></th>
		  <th><?php echo __("Category", 'wp-support-plus-responsive');?></th>
	  </tr>
	...
	<ul class="pager" style="<?php echo ($total_pages==0)? 'display: none;':'';?>">
	  <li class="previous <?php echo $prev_class;?>"><a href="javascript:load_prev_page_faq(<?php echo $prev_page_no;?>);">&larr; <?php _e('Newer','wp-support-plus-responsive');?></a></li>
	  <li><?php echo $current_page;?> of <?php echo $total_pages;?> Pages</li>
	  <li class="next <?php echo $next_class;?>"><a href="javascript:load_next_page_faq(<?php echo $next_page_no;?>);"><?php _e('Older','wp-support-plus-responsive');?> &rarr;</a></li>
	</ul>
	<div style="text-align: center;<?php echo ($total_pages==0)? '':'display: none;';?>"><?php _e('No Faqs Found','wp-support-plus-responsive');?></div>
