		...
		<tr>
			...
			<td>
				<select id="filter_by_status" name="filter_by_status">
					<option value="all" <?php echo ($user_filter['filter_by_status']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<?php
					...
					if($total_statusses)
					{
						foreach($custom_statusses as $custom_status){?>
							<option value="<?php echo strtolower($custom_status->name);?>" <?php echo ($user_filter['filter_by_status']==strtolower($custom_status->name))?'selected="selected"':'';?>><?php _e(ucfirst($custom_status->name),'wp-support-plus-responsive');?></option>
						<?php
						}
					}
					?>
		...
		<tr>
			...
			<td>
				<select id="filter_by_type" name="filter_by_type">
					<option value="all" <?php echo ($user_filter['filter_by_type']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<option value="user" <?php echo ($user_filter['filter_by_type']=='user')?'selected="selected"':'';?>><?php _e('User','wp-support-plus-responsive');?></option>
					<option value="guest" <?php echo ($user_filter['filter_by_type']=='guest')?'selected="selected"':'';?>><?php _e('Guest','wp-support-plus-responsive');?></option>
				</select>
			</td>
		</tr>
	</table>
...
<div class="filter_item">
	<table>
		<tr>
			<td><?php _e($default_labels['dc'].':','wp-support-plus-responsive');?></td>
			<td>
				<select id="filter_by_category" name="filter_by_category">
					<option value="all" <?php echo ($user_filter['filter_by_category']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<?php 
		...
		<tr>
			...
			<td>
				<select id="filter_by_assigned_to" name="filter_by_assigned_to">
					<option value="all" <?php echo ($user_filter['filter_by_assigned_to']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<option value="0" <?php echo ($user_filter['filter_by_assigned_to']=='0')?'selected="selected"':'';?>><?php _e('None','wp-support-plus-responsive');?></option>
					<?php 
...
<div class="filter_item">
	<table>
		<tr>
			<td><?php _e($default_labels['dp'].':','wp-support-plus-responsive');?></td>
			<td>
				<select id="filter_by_priority" name="filter_by_priority">
					<option value="all" <?php echo ($user_filter['filter_by_priority']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<?php
					...
					if($total_priorities)
					{
						foreach($custom_priorities as $custom_priority){?>
							<option value="<?php echo $custom_priority->name;?>" <?php echo ($user_filter['filter_by_priority']==strtolower($custom_priority->name))?'selected="selected"':'';?>><?php _e($custom_priority->name,'wp-support-plus-responsive');?></option>
						<?php
						}
					}
					?>
...
<div class="filter_item">
	<table>
		<tr>
			<td><?php _e($advancedSettings['ticket_label_alice'][12],'wp-support-plus-responsive');?>:</td>
			<td>
				<select id="filter_by_no_of_ticket" name="filter_by_no_of_ticket">
					<option value="10" <?php echo ($user_filter['filter_by_no_of_ticket']=='10')?'selected="selected"':'';?>><?php _e('10','wp-support-plus-responsive');?></option>
					<option value="20" <?php echo ($user_filter['filter_by_no_of_ticket']=='20')?'selected="selected"':'';?>><?php _e('20','wp-support-plus-responsive');?></option>
					<option value="30" <?php echo ($user_filter['filter_by_no_of_ticket']=='30')?'selected="selected"':'';?>><?php _e('30','wp-support-plus-responsive');?></option>
					<option value="40" <?php echo ($user_filter['filter_by_no_of_ticket']=='40')?'selected="selected"':'';?>><?php _e('40','wp-support-plus-responsive');?></option>
					<option value="50" <?php echo ($user_filter['filter_by_no_of_ticket']=='50')?'selected="selected"':'';?>><?php _e('50','wp-support-plus-responsive');?></option>
					<option value="100" <?php echo ($user_filter['filter_by_no_of_ticket']=='100')?'selected="selected"':'';?>><?php _e('100','wp-support-plus-responsive');?></option>
					<option value="500" <?php echo ($user_filter['filter_by_no_of_ticket']=='500')?'selected="selected"':'';?>><?php _e('500','wp-support-plus-responsive');?></option>
				</select>
			</td>
		</tr>
	</table>
			...
			<tr>
				...
				<td>
					<select id="custd<?php echo $field->id;?>" name="cust<?php echo $field->id;?>">
						<option value="all" <?php echo ($user_filter['cust'.$field->id]=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
						<?php 
...
<div class="filter_center">
	<?php _e('Search By:','wp-support-plus-responsive');?>&nbsp;&nbsp;&nbsp;
	<select id="filter_by_selection" name="filter_by_selection">
		<option value="text" <?php echo ($user_filter['filter_by_selection']=='text')?'selected="selected"':'';?>><?php _e('Text','wp-support-plus-responsive');?></option>
		<option value="id" <?php echo ($user_filter['filter_by_selection']=='id')?'selected="selected"':'';?>><?php _e('ID','wp-support-plus-responsive');?></option>		
		<option value="created_by" <?php echo ($user_filter['filter_by_selection']=='created_by')?'selected="selected"':'';?>><?php _e('Created By','wp-support-plus-responsive');?></option>
		
	</select>
</div>
<div class="filter_center">
	<input type="text" id="filter_by_search" name="filter_by_search" placeholder="<?php _e('Search...','wp-support-plus-responsive');?>" value="<?php echo $user_filter['filter_by_search'];?>" />
</div>
<div class="filter_center">
	<button type="submit" class='btn btn-success'><?php _e('Apply & Remember','wp-support-plus-responsive');?></button>
	<button type="button" class='btn btn-success' onclick="wpspHideFilterDashboardBody();"><?php _e('Cancel','wp-support-plus-responsive');?></button>
</div>
