...
<div id="menuDisplayTableContainer" class="table-responsive">
	<table class="table table-striped">
	  <tr>
	    <th><?php _e('Icon','wp-support-plus-responsive');?></th>
	    <th><?php _e('Menu','wp-support-plus-responsive');?></th>
	    <th><?php _e('Redirect URL','wp-support-plus-responsive');?></th>
	  ...
	  <?php foreach ($menus as $menu){?>
	  	<tr>
	  		...
	  		<td><img onclick="delete_custom_menu(<?php echo $menu->id;?>);" style="cursor: pointer;" title="<?php _e('Delete','wp-support-plus-responsive');?>" src="<?php echo WCE_PLUGIN_URL;?>asset/images/delete.png" ></td>
	  	</tr>
	  <?php }?>
	</table>
</div>
<?php if(!$total_menu){?>
	<div style="width: 100%;text-align: center;"><?php _e('No Menus Found','wp-support-plus-responsive');?></div>
	<hr>
<?php }?>

<div id="add_custom_menu_container">
	<h4><?php _e('Add New Menu','wp-support-plus-responsive');?></h4>
	<input type="hidden" id="custom_menu_icon" value="<?php echo WCE_PLUGIN_URL;?>asset/images/custom_menu_default.jpg" >
	<table>
		<tr>
			<td><?php _e('Select Icon (40 x 40 pixel)','wp-support-plus-responsive');?></td>
		...
		<tr>
			<td><?php _e('Menu Text','wp-support-plus-responsive');?></td>
			<td class="seperator_menu_items">:</td>
			<td><input type="text" id="custom_menu_text" value="" ></td>
		</tr>
		<tr>
			<td><?php _e('Redirect URL','wp-support-plus-responsive');?></td>
			<td class="seperator_menu_items">:</td>
			<td><input type="text" id="custom_menu_url" value="" ></td>
		</tr>
	</table><br>
	<button class="btn btn-success" onclick="create_custom_panel_menu();" ><?php _e('Create New Menu','wp-support-plus-responsive');?></button>
</div>
