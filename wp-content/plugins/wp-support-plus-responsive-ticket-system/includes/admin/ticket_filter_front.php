		...
		<tr>
			...
			<td>
				<select id="filter_by_status_front" name="filter_by_status_front">
					<option value="all" <?php echo ($user_filter['filter_by_status_front']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<?php
					...
					if($total_statusses)
					{
						foreach($custom_statusses as $custom_status){?>
							...
							<option value="<?php echo strtolower($custom_status->name)?>" <?php echo ($user_filter['filter_by_status_front']==strtolower($custom_status->name))?'selected="selected"':'';?>><?php _e(ucfirst($custom_status->name),'wp-support-plus-responsive');?></option>
                                                    <?php }?>    
						<?php
						}
					}
		...
		<tr>
			...
			<td>
				<select id="filter_by_category_front" name="filter_by_category_front">
					<option value="all" <?php echo ($user_filter['filter_by_category_front']=='all')?'selected="selected"':'';?>><?php _e('All','wp-support-plus-responsive');?></option>
					<?php 
		...
		<tr>
			...
			<td>
				<select id="filter_by_no_of_ticket_front" name="filter_by_no_of_ticket_front">
					<option value="10" <?php echo ($user_filter['filter_by_no_of_ticket_front']=='10')?'selected="selected"':'';?>><?php _e('10','wp-support-plus-responsive');?></option>
					<option value="20" <?php echo ($user_filter['filter_by_no_of_ticket_front']=='20')?'selected="selected"':'';?>><?php _e('20','wp-support-plus-responsive');?></option>
					<option value="30" <?php echo ($user_filter['filter_by_no_of_ticket_front']=='30')?'selected="selected"':'';?>><?php _e('30','wp-support-plus-responsive');?></option>
					<option value="40" <?php echo ($user_filter['filter_by_no_of_ticket_front']=='40')?'selected="selected"':'';?>><?php _e('40','wp-support-plus-responsive');?></option>
					<option value="50" <?php echo ($user_filter['filter_by_no_of_ticket_front']=='50')?'selected="selected"':'';?>><?php _e('50','wp-support-plus-responsive');?></option>
				</select>
			</td>
		</tr>
	</table>
...
<div class="filter_item">
	<table>
		<tr>
			<td><?php _e('By:','wp-support-plus-responsive');?></td>
			<td>
				<select id="filter_by_selection_front" name="filter_by_selection_front">
					<option value="text" <?php echo ($user_filter['filter_by_selection_front']=='text')?'selected="selected"':'';?>><?php _e('Text','wp-support-plus-responsive');?></option>
					<option value="id" <?php echo ($user_filter['filter_by_selection_front']=='id')?'selected="selected"':'';?>><?php _e('ID','wp-support-plus-responsive');?></option>
				</select>
			</td>
			<td><input type="text" id="filter_by_search_front" name="filter_by_search_front" size="10" placeholder="<?php _e('Search...','wp-support-plus-responsive');?>" /></td>
		</tr>
	</table>
</div>
...
<div class="filter_center">
	...
	<button type="button" class='btn btn-success' onclick="wpspHideFilterFrontBody();"><?php _e('Cancel','wp-support-plus-responsive');?></button>
</div>
