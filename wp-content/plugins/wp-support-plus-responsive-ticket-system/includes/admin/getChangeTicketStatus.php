...
$sql="select subject,type,status,cat_id,priority,created_by,guest_name,updated_by,assigned_to,ticket_type
...
?>
  <tr>
    <td><?php _e($advancedSettings['ticket_label_alice'][11],'wp-support-plus-responsive');?></td>
    <td>:</td>
    <td>
    	<select id="change_status_type">
			<option value="0" <?php echo ($ticket->ticket_type=='0')?'selected="selected"':'';?>><?php _e('Private','wp-support-plus-responsive');?></option>
			<option value="1" <?php echo ($ticket->ticket_type=='1')?'selected="selected"':'';?>><?php _e('Public','wp-support-plus-responsive');?></option>
	</select>
    </td>
  </tr>
  <?php
...
?>
<tr>
	<td><?php _e('Notify','wp-support-plus-responsive');?></td>
	<td>:</td>
	<td>
		<select id="notify">
			<option value="1"><?php _e('Yes','wp-support-plus-responsive');?></option>
			<option value="0"><?php _e('No','wp-support-plus-responsive');?></option>
		</select>
	</td>
</tr>
<?php
