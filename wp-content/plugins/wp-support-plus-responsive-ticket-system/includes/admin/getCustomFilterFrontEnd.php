...
<div id="catDisplayTableContainer" class="table-responsive">
	<table id="custom_filter_front_end" class="table table-striped">
		...
		<tr>
			...
			<th><?php _e('Logged In Users','wp-support-plus-responsive');?></th>
			<th><?php _e('Agents','wp-support-plus-responsive');?></th>
			<th><?php _e('Supervisors','wp-support-plus-responsive');?></th>
		</tr>
		</thead>
		<tbody><?php
			$field_num=1;
			...
			{	if(is_numeric($field_id))
				{
					...
					<tr id="<?php echo $field_num;?>">
						...
						<td>
							...
							<input type="checkbox" id="logged_in_<?php echo $field_id;?>" name="filter_field_<?php echo $field_id;?>" value="1" <?php echo $checked;?>><?php _e('Show','wp-support-plus-responsive');?>
						</td>
						<td>
							...
							<input type="checkbox" id="agents_<?php echo $field_id;?>" name="filter_field_<?php echo $field_id;?>" value="1" <?php echo $checked;?>><?php _e('Show','wp-support-plus-responsive');?>
						</td>
						<td>
							...
							<input type="checkbox" id="supervisors_<?php echo $field_id;?>" name="filter_field_<?php echo $field_id;?>" value="1" <?php echo $checked;?>><?php _e('Show','wp-support-plus-responsive');?>
						</td>
					</tr>
				<?php
				}
				else
				{
					switch($field_id){
						...
						case 'tt':?>
							<tr id="<?php echo $field_num;?>">
								<td><?php echo $field_num++;?></td>
								<td><?php _e('Text','wp-support-plus-responsive');?></td>
								<td style="display:none;"><?php echo $field_id;?></td>
								<td>
									<?php if(is_array($advancedSettingsCustomFilterFront['logged_in']) && in_array($field_id,$advancedSettingsCustomFilterFront['logged_in'])){ 
										$checked="checked='checked'";
...
<input type="button" onclick="setCustomFilterFrontEnd();" class="btn btn-success" value="<?php _e('Save Settings','wp-support-plus-responsive');?>">
