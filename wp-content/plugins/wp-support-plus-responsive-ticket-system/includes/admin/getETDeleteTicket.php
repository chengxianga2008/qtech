...
<form id='frmETDeleteTicket'>
	<span class="label label-info wpsp_title_label">
	<?php _e($advancedSettings['ticket_label_alice'][15], 'wp-support-plus-responsive' );?>
	</span><br><br>
	<table class='wpsp_et_role_tbl'>
	  ...
	  <tr>
        ...
        [<?php echo __($advancedSettings['ticket_label_alice'][1],'wp-support-plus-responsive');?> <?php echo $advancedSettings['wpsp_ticket_id_prefix'];?>] <input type="text" id='wpsp_et_delete_subject' name='wpsp_et_delete_subject' style="width: 50%;" value='<?php echo htmlspecialchars(stripcslashes($wpsp_et_delete_ticket['mail_subject']), ENT_QUOTES);?>'/><br>
