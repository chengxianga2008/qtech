...
foreach($statusses as $status){
	...
	?>
	<span class="label stat_heading" style="background-color:<?php echo $status->color?>"><?php echo $status->name." ".__($advancedSettings['ticket_label_alice'][2],'wp-support-plus-responsive').': '.$total_none_tickets;?></span>
	<?php
	$count++;
}
?><br><br>
...
<div class="table-responsive">
	<table class="table table-striped">
		<tr>
			...
			<?php
				foreach($statusses as $status){
					?><th><?php echo $status->name." ".__($advancedSettings['ticket_label_alice'][2],'wp-support-plus-responsive');?></th><?php
				}
			?>
		</tr>
		<tr>
