...
<div class="wpspFilterDashboard">
	<button id="wpspBtnApplyTicketFilter" class="btn btn-primary" onclick="wpsp_open_apply_filter();"><?php _e('Apply Filter', 'wp-support-plus-responsive');?></button>
	<button id="wpspBtnResetTicketFilter" class="btn btn-primary" onclick="wpsp_reset_filter();"><?php _e('Reset Filter', 'wp-support-plus-responsive');?></button>
        ...
        <?php if( $emailSettings['enable_email_pipe'] && $emailSettings['piping_type']=='imap' && $current_user->has_cap('manage_support_plus_agent') && class_exists('WPSupportPlusEmailPipe') ){ ?>
            <button id="wpspBtnSynkIMAP" class="btn btn-primary" onclick="wpsp_imap_loader();"><?php _e('Sync Emails', 'wp-support-plus-responsive');?></button>
        <?php }?>
        
	<button id="wpspBtnChangeBulkStatus" class="btn btn-primary wpspBulkActionBtn" onclick="wpspOpenBulkChangeStatus();"><?php _e('Change Status', 'wp-support-plus-responsive');?></button>
	<?php if($current_user->has_cap('manage_support_plus_agent')){?>
	<button id="wpspBtnAssignBulkTickets" class="btn btn-primary wpspBulkActionBtn" onclick="wpspOpenBulkAssignAgent();"><?php _e('Assign Agent', 'wp-support-plus-responsive');?></button>
	<button id="wpspBtnDeleteBulkTickets" class="btn btn-danger wpspBulkActionBtn" onclick="wpspBulkTicketDelete();"><?php _e('Delete', 'wp-support-plus-responsive');?></button>
	<?php }
