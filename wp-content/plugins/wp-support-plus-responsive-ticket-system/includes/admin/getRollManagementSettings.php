...
<span class="label label-info wpsp_title_label"><?php _e('Front End Restriction','wp-support-plus-responsive');?></span><br><br>
<small><code>*</code><?php _e('This will allow','wp-support-plus-responsive');?> <b><?php _e('Registered Users','wp-support-plus-responsive');?></b> <?php _e('to raise/view tickets from front end.','wp-support-plus-responsive');?></small><br>
<table>
<?php
$userRoles=$wp_roles->roles; 
	?><tr>
            ...
            <td id="cmbEmail_front_new_ticket_all_label"><?php _e('All','wp-support-plus-responsive');?></td>
	</tr><?php
foreach ($userRoles as $roleSlug=>$role){
	if($roleSlug=='administrator' || $roleSlug=='wp_support_plus_agent' || $roleSlug=='wp_support_plus_supervisor') continue;
	?>
