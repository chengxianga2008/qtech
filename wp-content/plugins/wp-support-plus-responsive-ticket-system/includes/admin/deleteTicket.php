 ...
 */
$et_success_staff_subject='['.__($advancedSettings['ticket_label_alice'][1],'wp-support-plus-responsive').' '.$advancedSettings['wpsp_ticket_id_prefix'].$_POST['ticket_id'].'] '.stripslashes($wpsp_et_delete_ticket['mail_subject']);
...
$attachment_ids= $wpdb->get_var( $sql );
