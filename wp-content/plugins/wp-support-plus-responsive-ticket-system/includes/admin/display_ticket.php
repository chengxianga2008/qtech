...
<ul class="nav nav-tabs">
	<li class="active"><a href="#ticketContainer" id="tab_ticket_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][2],'wp-support-plus-responsive');?></a></li>
	<li><a href="#create_ticket" id="tab_create_ticket" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][3],'wp-support-plus-responsive');?></a></li>
