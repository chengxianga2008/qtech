...
if(isset($_REQUEST['ticket_id'])){
    ...
    if(is_numeric($ticket_id)){
         ...
         */
        ?>
        <h3><?php echo '['.__($advancedSettings['ticket_label_alice'][1],'wp-support-plus-responsive').' #'.$_POST['ticket_id'].'] '.stripcslashes(htmlspecialchars_decode($ticket->subject,ENT_QUOTES));?></h3><br>
        <?php
        /*
            ...
            <div class="threadContainer">
                ...
                foreach ($customFields as $field) {
                    if (in_array($field->id, $advancedSettingsFieldOrder['display_fields'])) {
                        ...
                        if (!$fieldValue)
                            $fieldValue = __('', 'wp-support-plus-responsive');
