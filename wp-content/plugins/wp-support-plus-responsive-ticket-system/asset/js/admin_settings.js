...
function editCategory(id,default_assignee){
...
function editCustomField(id,name,required,field_type,field_options,field_ids){
...
function updateCustomField(){
	if(jQuery('#editCustFieldName').val().trim()!=''){
		if((jQuery('#editFieldType').val()=='2' && jQuery('#editFieldOptions').val().trim()!='') || (jQuery('#editFieldType').val()=='3' && jQuery('#editFieldOptions').val().trim()!='') || (jQuery('#editFieldType').val()=='4' && jQuery('#editFieldOptions').val().trim()!='') || (jQuery('#editFieldType').val()=='1') || (jQuery('#editFieldType').val()=='5')  || (jQuery('#editFieldType').val()=='6')) {
			jQuery('#settingsCustomFields .wait').show();
			jQuery('#settingsCustomFields .settingsCustomFieldsContainer').hide();
			var required=0;
